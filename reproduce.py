...
STAGES = [
    ...
    ("FORRT TF-IDF-on-fingerprint (2nd lexical reader) + 16-excluded worst-case bound",
    ...
    ("Unsupervised isolation beats supervised classifiers (Results II)",
    ...
    ("Abstract-vs-full-text per lens (the experiment lens prefers full text)",
     "experiment_perlens.py", True),
    ("Raw vs abstract-fingerprint vs improved-full-text-fingerprint",
